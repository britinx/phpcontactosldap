...
<head>
	...
	<title>Página no encontrada - Contactos LDAP</title>
...
<div class="large-12 columns">
	...
	<h3>Aparentemente la página no existe, o se encuentra en mantenimiento.</h3>
	<br/>
	<a href="<?php echo $_SERVER["HTTP_REFERER"];?>"><input type="submit" class="button alert expand" name="button" id="button" value="Haga click aquí para regresar"/></a>
</div>
</div>
